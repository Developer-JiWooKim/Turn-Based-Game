...
namespace Assets.MyAssets.Scripts.Save
{
    ...
    public static class SaveService
    {
        ...
        {
#if UNITY_EDITOR
            // Application.dataPath = <프로젝트 루트>/Assets 이므로, 한 단계 위가 프로젝트 루트다.
        ...
        public static SaveData Load()
        {
            ...
            {
                // 세이브가 깨진 경우 — 진행 기록은 잃지만 게임은 계속 실행되어야 한다.
        ...
        /// <summary>현재 세이브 데이터를 파일에 기록한다.</summary>
        ...
        /// <summary>
        /// 런 종료 시 도달 스테이지를 기록한다. 기록을 새로 세웠을 때만 파일에 쓴다.
        /// </summary>
        ...
        /// <summary>세이브를 삭제하고 기본값으로 되돌린다(개발·테스트용).</summary>
