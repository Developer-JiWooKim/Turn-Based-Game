...
로그라이크 루프(선택지 9종·파티 영입/교체·파티 시너지·스테이지 스케일링·6스테이지 이후 랜덤 스폰·사망 시 영구 추방)와 전멸 결과 화면, BGM/SFX까지 돌아가며, 남은 것은 주로 영구 포인트 배분 UI·옵션 메뉴(해상도/언어)·밸런싱.
